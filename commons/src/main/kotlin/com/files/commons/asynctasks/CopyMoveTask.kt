package com.files.commons.asynctasks
...
import com.files.commons.helpers.getConflictResolution
import com.files.commons.helpers.isOreoPlus
...
class CopyMoveTask(
    val activity: BaseSimpleScreenActivity, val copyOnly: Boolean, val copyMediaOnly: Boolean, val conflictResolutions: LinkedHashMap<String, Int>,
