package com.files.commons.views.bottomactionmenu
...
class BottomActionMenuPopup(private val activity: BaseSimpleScreenActivity, items: List<BottomActionMenuItem>) {
    ...
    constructor(activity: BaseSimpleScreenActivity, @MenuRes menuResId: Int) : this(activity, BottomActionMenuParser(activity).inflate(menuResId))
