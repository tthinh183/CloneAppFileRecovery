package com.files.commons.views
...
import com.files.commons.helpers.isNougatPlus
import com.files.commons.interfaces.RenameTab
import com.files.commons.models.Android30RenameFormat
...
class RenamePatternTab(context: Context, attrs: AttributeSet) : RelativeLayout(context, attrs), RenameTab {
    ...
    var numbersCnt = 0
    var activity: BaseSimpleScreenActivity? = null
    ...
    override fun initTab(activity: BaseSimpleScreenActivity, paths: ArrayList<String>) {
