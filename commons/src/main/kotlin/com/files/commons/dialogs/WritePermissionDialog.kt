...
import com.files.commons.extensions.humanizePath
...
class WritePermissionDialog(activity: Activity, val mode: Mode, val callback: () -> Unit) {
    ...
    init {
        ...
        activity.getAlertDialogBuilder()
            ...
            .setOnCancelListener {
                BaseSimpleScreenActivity.funAfterSAFPermission?.invoke(false)
                BaseSimpleScreenActivity.funAfterSAFPermission = null
            }
            .apply {
