...
import com.files.commons.R.id.conflict_dialog_radio_keep_both
import com.files.commons.R.id.conflict_dialog_radio_merge
import com.files.commons.R.id.conflict_dialog_radio_skip
import com.files.commons.extensions.baseConfig
import com.files.commons.extensions.beVisibleIf
import com.files.commons.extensions.getAlertDialogBuilder
import com.files.commons.extensions.setupDialogStuff
import com.files.commons.helpers.CONFLICT_KEEP_BOTH
import com.files.commons.helpers.CONFLICT_MERGE
import com.files.commons.helpers.CONFLICT_OVERWRITE
import com.files.commons.helpers.CONFLICT_SKIP
