...
import com.files.commons.helpers.SILENT
import com.files.commons.models.AlarmSound
import com.files.commons.models.RadioItem
import com.files.commons.views.MyCompatRadioButton
import kotlinx.android.synthetic.main.dialog_select_alarm_sound.view.*

class SelectAlarmSoundDialog(
    val activity: BaseSimpleScreenActivity, val currentUri: String, val audioStream: Int, val pickAudioIntentId: Int,
