...
import com.files.commons.dialogs.ConfirmationAdvancedDialog
import com.files.commons.dialogs.RateStarsDialog
import com.files.commons.extensions.*
import com.files.commons.helpers.*
import com.files.commons.models.FAQItem
import kotlinx.android.synthetic.main.activity_about.*

class AboutScreenActivity : BaseSimpleScreenActivity() {
    private var appName = ""
    ...
    private fun setupFAQ() {
        ...
        about_faq_holder.setOnClickListener {
            Intent(applicationContext, FAQScreenActivity::class.java).apply {
    ...
    private fun setupContributors() {
        ...
        about_contributors_holder.setOnClickListener {
            val intent = Intent(applicationContext, ContributorsScreenActivity::class.java)
    ...
    private fun setupLicense() {
        ...
        about_licenses_holder.setOnClickListener {
            Intent(applicationContext, LicenseScreenActivity::class.java).apply {
                putExtra(APP_ICON_IDS, getAppIconIDs())
                putExtra(APP_LAUNCHER_NAME, getAppLauncherName())
