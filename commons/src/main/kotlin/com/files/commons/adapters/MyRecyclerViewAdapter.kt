...
import com.files.commons.interfaces.MyActionModeCallback
import com.files.commons.views.MyRecyclerView

abstract class MyRecyclerViewAdapter(val activity: BaseSimpleScreenActivity, val recyclerView: MyRecyclerView, val itemClick: (Any) -> Unit) :
