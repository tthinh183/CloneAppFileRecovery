...
import com.files.commons.dialogs.*
import com.files.commons.dialogs.WritePermissionDialog.Mode
import com.files.commons.helpers.*
import com.files.commons.models.*
import com.files.commons.views.MyTextView
...
fun BaseSimpleScreenActivity.isShowingSAFDialog(path: String): Boolean {
...
fun BaseSimpleScreenActivity.isShowingSAFDialogSdk30(path: String): Boolean {
...
@SuppressLint("InlinedApi")
fun BaseSimpleScreenActivity.isShowingSAFCreateDocumentDialogSdk30(path: String): Boolean {
...
fun BaseSimpleScreenActivity.isShowingAndroidSAFDialog(path: String): Boolean {
...
fun BaseSimpleScreenActivity.isShowingOTGDialog(path: String): Boolean {
...
fun BaseSimpleScreenActivity.showOTGPermissionDialog(path: String) {
    runOnUiThread {
        if (!isDestroyed && !isFinishing) {
...
fun BaseSimpleScreenActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
...
fun BaseSimpleScreenActivity.checkWhatsNew(releases: List<Release>, currVersion: Int) {
...
fun BaseSimpleScreenActivity.deleteFolders(folders: List<FileDirItem>, deleteMediaOnly: Boolean = true, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    ensureBackgroundThread {
        deleteFoldersBg(folders, deleteMediaOnly, callback)
    }
}

fun BaseSimpleScreenActivity.deleteFoldersBg(folders: List<FileDirItem>, deleteMediaOnly: Boolean = true, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
...
fun BaseSimpleScreenActivity.deleteFolder(folder: FileDirItem, deleteMediaOnly: Boolean = true, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    ensureBackgroundThread {
        deleteFolderBg(folder, deleteMediaOnly, callback)
    }
}

fun BaseSimpleScreenActivity.deleteFolderBg(fileDirItem: FileDirItem, deleteMediaOnly: Boolean = true, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
...
fun BaseSimpleScreenActivity.deleteFile(file: FileDirItem, allowDeleteFolder: Boolean = false, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    deleteFiles(arrayListOf(file), allowDeleteFolder, callback)
}

fun BaseSimpleScreenActivity.deleteFiles(files: List<FileDirItem>, allowDeleteFolder: Boolean = false, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    ensureBackgroundThread {
        deleteFilesBg(files, allowDeleteFolder, callback)
    }
}

fun BaseSimpleScreenActivity.deleteFilesBg(files: List<FileDirItem>, allowDeleteFolder: Boolean = false, callback: ((wasSuccess: Boolean) -> Unit)? = null) {
    if (files.isEmpty()) {
        runOnUiThread {
            callback?.invoke(true)
        }
...
private fun BaseSimpleScreenActivity.deleteFilesCasual(
...
fun BaseSimpleScreenActivity.deleteFile(
...
fun BaseSimpleScreenActivity.deleteFileBg(
    fileDirItem: FileDirItem,
    allowDeleteFolder: Boolean = false,
    isDeletingMultipleFiles: Boolean,
    callback: ((wasSuccess: Boolean) -> Unit)? = null,
...
private fun BaseSimpleScreenActivity.deleteSdk30(fileDirItem: FileDirItem, callback: ((wasSuccess: Boolean) -> Unit)?) {
...
fun BaseSimpleScreenActivity.renameFile(
    oldPath: String,
    newPath: String,
...
private fun BaseSimpleScreenActivity.renameCasually(
    oldPath: String,
    newPath: String,
    isRenamingMultipleFiles: Boolean,
...
fun BaseSimpleScreenActivity.getFileOutputStream(fileDirItem: FileDirItem, allowCreatingNewFile: Boolean = false, callback: (outputStream: OutputStream?) -> Unit) {
...
fun BaseSimpleScreenActivity.showFileCreateError(path: String) {
    val error = String.format(getString(R.string.could_not_create_file), path)
    baseConfig.sdTreeUri = ""
    showErrorToast(error)
}

fun BaseSimpleScreenActivity.getFileOutputStreamSync(path: String, mimeType: String, parentDocumentFile: DocumentFile? = null): OutputStream? {
...
private fun createCasualFileOutputStream(activity: BaseSimpleScreenActivity, targetFile: File): OutputStream? {
...
fun BaseSimpleScreenActivity.createDirectorySync(directory: String): Boolean {
...
fun BaseSimpleScreenActivity.getAlarmSounds(type: Int, callback: (ArrayList<AlarmSound>) -> Unit) {
...
fun BaseSimpleScreenActivity.getTempFile(folderName: String, fileName: String): File? {
