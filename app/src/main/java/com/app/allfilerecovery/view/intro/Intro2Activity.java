    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Admob.getInstance().loadNativeAdFloor(this, AdsUtils.listNativeIntroId, new NativeCallback() {
            ...
            public void onNativeAdLoaded(NativeAd nativeAd) {
                ...
                NativeAdView adView = (NativeAdView) LayoutInflater.from(Intro2Activity.this).inflate(R.layout.ads_native_intro_small, null);
...
//        });
    ...
    private void moveForward() {
        ...
        if(firstStart){
            Intent intent = new Intent(Intro2Activity.this, PermissionActivity.class);
...
//        agreeText = findViewById(R.id.agree_image);
    ...
    private void configMediationProvider() {
        ...
        //idInter = BuildConfig.inter_intro;
